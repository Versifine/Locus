...
func CreatePlayerPositionPacket(x, y, z float64, onGround, hasHorizontalCollision bool) *Packet {
	buf := new(bytes.Buffer)
	_ = WriteDouble(buf, x)
	_ = WriteDouble(buf, y)
	_ = WriteDouble(buf, z)
	_ = WriteByte(buf, encodeMovementFlags(onGround, hasHorizontalCollision))
	return &Packet{
...
func CreatePlayerPositionAndRotationPacket(x, y, z float64, yaw, pitch float32, onGround, hasHorizontalCollision bool) *Packet {
	buf := new(bytes.Buffer)
	_ = WriteDouble(buf, x)
	_ = WriteDouble(buf, y)
	_ = WriteDouble(buf, z)
